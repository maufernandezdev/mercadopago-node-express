...
const validar = (nombre, dni) => {
    if (nombre == "" || dni=="" || Number.isNaN(dni)){
         alert("Ingrese un nombre y dni, porfavor");
         nombre = prompt("Ingrese un nombre");
         dni = parseInt(prompt("Ingrese un numero de DNI"));
        
    } else{
       return alert(`su nombre es: ${nombre} y su dni:${dni}`);
    }
}

let usuarioValidado = validar(nombre,dni);
